<div>
    <div class="container mx-auto px-4">
        ...
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
            ...
            <div wire:click="$emit('savePost')" class="inline-flex justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition duration-150 ease-in-out bg-indigo-500 border border-transparent rounded-md hover:bg-indigo-600 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 cursor-pointer">Submit Post</div>
        </div>
    </div>
</div>
